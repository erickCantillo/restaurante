<div>
    ...
    <div class="py-12">
        ...
        <x-jet-confirmation-modal wire:model="confirmingProyectoAdd">
          ...
          <x-slot name="content">
              {{ __('Estas Seguro de Eliminar este proyecto? ') }}
          </x-slot>
   
          <x-slot name="footer">
              <x-jet-secondary-button wire:click="$set('confirmingProyectoDeletion', false)" wire:loading.attr="disabled">
                  {{ __('Cancelar') }}
        ...
        <x-jet-dialog-modal wire:model="confirmingProyectoAdd">
            <x-slot name="title">
            ...
            <x-slot name="content">
              <div class="col-span-6 sm:col-span-4 my-4">
                ...
                <x-jet-input id="nombre" type="text" class="mt-1 block w-full" wire:model.defer="proyecto.nombre" />
                <x-jet-input-error for="proyecto.nombre" class="mt-2" />
              </div>
              
                <div class="col-span-6 sm:col-span-4">
                    <x-jet-label for="imagen" value="{{ __('Foto') }}" />
            ...
            <x-slot name="footer">
                <x-jet-secondary-button wire:click="$set('confirmingProyectoAdd', false)" wire:loading.attr="disabled">
                    {{ __('Cancelar') }}
                </x-jet-secondary-button>
